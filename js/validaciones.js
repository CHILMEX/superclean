function validate() {
  ...
  if (direccion.length == 0 || direccion.length >100 || !valDirec) {
    ...
    if (opcion1.checked && opcion2.checked == true) {
      ...
      alert("Estimado/a " + opcion5+ " el valor de Ambos Servicios con IVA incluido es de " + Number(opcion3 + opcion4) * 1.19);
      return false;
    } else if (opcion1.checked == true) {
  
      alert("Estimado/a " + opcion5+ " el valor Servicio de " + opcion1.value + " con IVA incluido : " + "$" + opcion3 * 1.19);
      return false;
    } else if (opcion2.checked == true) {
      alert("Estimado/a " + opcion5+" el valor Servicio de " + opcion2.value + " con IVA incluido : " + "$" + opcion4 * 1.19);
      return false;
    } else {
